...
public class FibonacciResponse implements Parcelable {
	...
	@SuppressLint("NewApi")
	public FibonacciResponse(ParcelFileDescriptor mem1, int ack) {
	...
	public FileDescriptor getfd() {
		...
		Log.d(TAG, String.format("The fd int is a - %d",a));
		//FileInputStream fis = new FileInputStream(fd1);
		/*byte[] buffer = new byte[testString.length];
		try {
			fis.read(buffer, 0, testString.length);
			Log.d(TAG, String.format("Read the following %s from the method!!!", buffer));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			Log.d(TAG, String.format("Cant read from response as well :("));
			e.printStackTrace();
		}
		try {
			fis.close();
	...
	public static final Parcelable.Creator<FibonacciResponse> CREATOR = new Parcelable.Creator<FibonacciResponse>() {
		public FibonacciResponse createFromParcel(Parcel in) {
			return new FibonacciResponse(in.readFileDescriptor(), in.readInt());
		}
